...
HOOK_DEFINE_REPLACE(FieldEncountCheckEncounterSlots) {
    static Dpr::Field::EncountResult_o * Callback(FieldObjectEntity_o *entity, bool inGridmove) {
...
HOOK_DEFINE_REPLACE(SetFishingEncountEncounterSlots) {
    static Dpr::Field::EncountResult_o * Callback(int32_t inRodType, UnityEngine_Vector2Int_o position) {
...
HOOK_DEFINE_REPLACE(SetSweetEncountEncounterSlots) {
    static Dpr::Field::EncountResult_o * Callback() {
